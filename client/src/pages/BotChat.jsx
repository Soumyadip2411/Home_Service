...
const BotChat = () => {
  ...
  return (
    <>
      <div className="w-full max-w-xl flex justify-start mt-6 mb-2">
        
        <button
          onClick={() => navigate('/')}
          className="ml-4 inline-block bg-yellow-400 hover:bg-yellow-500 text-black font-medium px-4 py-2 rounded-full shadow transition"
        >
          Go Home
        </button>
      </div>
